...
configlib_CreateConfig()
{
	...
	configlib_ServerID = AutoExecConfig_CreateConVar("stamm_serverid", "1", "If you have more than one Server, type here your Server number in, e.g. 1. Server = 1. Will be append to the table name");
