...
public configlib_CreateConfig()
{
	...
	configlib_showpoints = AutoExecConfig_CreateConVar("stamm_showpoints", "480", "Shows every x Seconds all Players their Points (480 = 8 minutes)");
	...
	configlib_infotime = AutoExecConfig_CreateConVar("stamm_infotime", "300", "Info Message Interval in seconds (300 = 5 minutes)");
	configlib_join_show = AutoExecConfig_CreateConVar("stamm_join_show", "1", "1 = When a Player join, he see his points, 0 = OFF");
	configlib_lvl_up_sound = AutoExecConfig_CreateConVar("stamm_lvl_up_sound", "music/stamm/lvlup.mp3", "0 = Level Up Sound OFF, otherwise the Path to the sound, beginning after sound/");
	...
	configlib_see_text = AutoExecConfig_CreateConVar("stamm_see_text", "1", "1 = All see points , 0 = only the player, who write it in the chat");
	...
	configlib_tablename = AutoExecConfig_CreateConVar("stamm_table_name", "STAMM_DB", "Your Stamm Table Name, appends '_<serverid>' at the end!");
